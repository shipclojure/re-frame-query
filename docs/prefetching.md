...
(rfq/prefetch {:query :books/list :params {:page 2}})

;; Or dispatch ensure-query directly — same thing
(rf/dispatch [::rfq/ensure-query {:query :books/list :params {:page 2}}])
```
...
@(rf/subscribe [::rfq/query {:query :books/list :params {:page 2}}])
```
